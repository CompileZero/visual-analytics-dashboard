...
const Chart = ({ chartData = {} }) => {
    ...
    if (chartData.country == "Germany") {
        ...
        let labels = chartData.data.map(row => { let date = row.date.split("T")[0]; return date; });
        ...
        let labels = chartData.data.map(row => { let date = row["Date_of_report"].split(" ")[0]; return date; });
